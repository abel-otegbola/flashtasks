    ...
    <div className="flex flex-col gap-6 bg-white dark:bg-dark-bg md:rounded-[10px] p-6 h-full mb-4 animate-pulse">
      <div className="flex justify-between gap-6 items-start flex-wrap">
        ...
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-1 bg-gray-100 dark:bg-dark-bg p-1 rounded-lg border border-gray-500/[0.2]">
      ...
      <div className="grid lg:grid-cols-5 sm:grid-cols-2 grid-cols-1 gap-4 items-start">
        {Array.from({ length: 5 }).map((_, index) => (
          <div
            ...
            className="p-4 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-dark-bg/50 space-y-3"
          >
            ...
            <div className="flex flex-col gap-4 overflow-hidden transition-all duration-300 max-h-none">
              {Array.from({ length: 3 }).map((__, cardIndex) => (
                <div
                  ...
                  className="relative flex flex-col gap-3 p-4 rounded-[10px] border border-gray-100/10 bg-white dark:bg-dark-bg overflow-hidden"
                >
