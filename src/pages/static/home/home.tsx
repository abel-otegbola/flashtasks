    ...
    <main className="w-full dark:bg-dark-bg dark:text-gray-100 pb-20">
      <header className="relative flex flex-col justify-center items-center w-full dark:bg-dark/[0.4] py-20">
        ...
        <div className="flex flex-col text-center items-center justify-center gap-4 px-6 z-3">
          ...
          <div className="text-gray dark:text-gray-300 mb-6">
            <BlurReveal preset="slide-right"  duration={2}>Efficiently manage your tasks and boost productivity</BlurReveal>
          </div>
          <div className="flex gap-4 items-center justify-center flex-wrap w-full">
            <Button href="/auth/signup" className='py-[2px] sm:w-fit w-full'><BlurReveal preset="slide-right">Get started</BlurReveal></Button>
      ...
      <section className="flex flex-col gap-10 lg:px-[6%] md:px-[3%] p-4">
        ...
        <div className="relative flex lg:flex-nowrap items-end flex-wrap w-full gap-16 bg-gray-100 dark:bg-dark/[0.4] rounded-lg md:pl-[6%] p-12 pb-0">
          <div className="flex flex-col justify-between gap-8 lg:w-[45%] py-[6%]">
            ...
            <BlurReveal preset="slide-right"><p className="lg:text-[40px] text-[32px] lg:leading-[60px] sm:leading-[56px] leading-[40px]">Convert your spoken words into actionable tasks seamlessly</p></BlurReveal>
      ...
      <section className="flex flex-col gap-10 pt-20 pb-10 p-4 md:mx-[5%]" id="solutions">
        <div className="flex flex-col justify-center items-center mx-auto max-w-3xl gap-[19px] mb-10">
          ...
          <BlurReveal preset="slide-right"><h2 className="md:text-[32px] text-[28px] text-center font-medium leading-[120%] px-6">Work Smarter. Move Faster</h2></BlurReveal>
          <BlurReveal preset="slide-right"><p className='text-[#939395] md:w-[60%] w-[90%] mx-auto text-center'>FlashTasks helps teams and individuals simplify task management, improve collaboration, and stay productive with an organized all-in-one workspace.</p></BlurReveal>
        </div>
        ...
        <div className="grid md:grid-cols-2 max-w-12xl mx-auto gap-8 w-full">
          <Animate preset="zoomIn" duration={2} className="flex flex-col gap-4 border border-gray-500/[0.2] md:p-12 p-4">
            ...
            <BlurReveal preset="slide-right"><h2 className="font-medium text-center">Organize projects and daily tasks effortlessly</h2></BlurReveal>
          </Animate>  
          <Animate preset="zoomIn" duration={2} className="flex flex-col gap-4 border border-gray-500/[0.2] md:p-12 p-4">
            ...
            <BlurReveal preset="slide-right"><h2 className="font-medium text-center">Collaborate with teams in real time</h2></BlurReveal>
          </Animate> 
        </div>
