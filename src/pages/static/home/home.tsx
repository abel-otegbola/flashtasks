    ...
    <main className="w-full dark:bg-dark dark:text-gray-100 py-20 px-6">
      <header className="flex flex-col justify-center items-center w-full">
        ...
        <div className="flex flex-col text-center items-center justify-center gap-4 ">
          ...
          <h1 className="md:text-[48px] text-[28px] max-[400px]:text-[24px] font-semibold md:leading-[60px] leading-[40px]">
            Get tasks done <br />
            <span className="text-[#8E7CF8]">Faster</span> and more 
            <span className="relative bg-gradient-to-r from-[#8E7CF8] via-[#1AC464] to-[#1AC464] bg-clip-text text-transparent ml-3">
               Efficiently
