    ...
    <main className="w-full dark:bg-[#101010] dark:text-gray-100 pb-20">
      <header className="flex flex-col justify-center items-center w-full bg-[#F6F6F6]/[0.4] dark:bg-[#191919] py-20 px-6">
        ...
        <div className="flex flex-col text-center items-center justify-center gap-4 ">
          ...
          <div className="relative flex flex-col text-[48px] max-[400px]:text-[40px] font-semibold md:leading-[60px] leading-[56px] max-[400px]:leading-[50px]">
            ...
            <BlurReveal preset="slide-right" duration={3}><h1>Get tasks done</h1></BlurReveal>
          ...
          <div className="text-gray dark:text-gray-300 mb-6">
            <BlurReveal preset="slide-right" duration={3}>Efficiently manage your tasks and boost productivity</BlurReveal>
          </div>
          <div className="flex gap-4 items-center justify-center flex-wrap w-full">
            <Button href="/auth/signup" className='py-[2px] sm:w-fit w-full'><BlurReveal preset="slide-right" duration={3}>Get free demo</BlurReveal></Button>
            <Button href="/auth/signup" variant='secondary' className='py-[2px] sm:w-fit w-full'><BlurReveal preset="slide-right" duration={3}>Learn more</BlurReveal></Button>
          </div>
          ...
          <div className='grid sm:grid-cols-3 gap-4 w-3.5xl mt-6'>
            {
              ["Real-time collaboration", "Intelligent task automation", "Customizable analytics dashboard"].map((feature) => (
                <div key={feature} className='flex gap-2 items-center justify-center'>
                  ...
                  <BlurReveal preset="slide-right" duration={3} className='text-gray-500'>{feature}</BlurReveal>
                </div>
              ))
            }
          </div>
        ...
        <div className="flex flex-col justify-center items-center py-[60px] p-4 md:w-[65%] w-full">
          ...
          <BlurReveal preset="slide-right" duration={3}><h2 className="font-medium mt-20 mb-4 text-center">Join 500+ teams saving 10+ hours/week of quality time</h2></BlurReveal>
      ...
      <section className="flex flex-col gap-10 lg:px-[6%] md:px-[3%] p-4">
        ...
        <div className="flex flex-col justify-center items-center mx-auto max-w-3xl gap-[19px] mb-10 text-center">
          <BlurReveal preset="slide-right" duration={3} className="font-medium flex items-center gap-2 border border-gray-500/[0.2] rounded-full px-6 py-2">
            <LightningIcon />
            Why People Choose Flashtasks
          </BlurReveal>
          <BlurReveal preset="slide-right" duration={3}><h2 className="md:text-[32px] text-[28px] font-medium leading-[120%]">Built to help teams move faster with less effort</h2></BlurReveal>
          <BlurReveal preset="slide-right" duration={3}><p className='text-[#939395] md:w-[60%] w-[90%] mx-auto'>Flashtasks keeps planning, prioritization, and collaboration in one simple workspace.</p></BlurReveal>
        </div>
        ...
        <div className="grid md:grid-cols-3 max-w-6xl mx-auto md:gap-[60px] gap-8">
          <div className="flex flex-col gap-4 border border-gray-500/[0.2] p-12">
            ...
            <BlurReveal preset="slide-right" duration={3}><h2 className="font-medium">AI Task Breakdown</h2></BlurReveal>

            <BlurReveal preset="slide-right" duration={3}><p>Turn overwhelming projects into actionable steps instantly.</p></BlurReveal>
          ...
          <div className="flex flex-col gap-4 border border-gray-500/[0.2] p-12">
            ...
            <BlurReveal preset="slide-right" duration={3}><h2 className="font-medium">Smart Daily Planning</h2></BlurReveal>

            <BlurReveal preset="slide-right" duration={3}><p>Automatically organize your day with AI-powered prioritization.</p></BlurReveal>
            <div className='flex-1 flex items-end'>
          ...
          <div className="flex flex-col gap-4 border border-gray-500/[0.2] p-12 bg-primary text-white">
            ...
            <BlurReveal preset="slide-right" duration={3}><h2 className="font-medium">Collaborate Anywhere</h2></BlurReveal>

            <BlurReveal preset="slide-right" duration={3}><p>Manage tasks with teammates, clients, or study groups in shared workspaces.</p></BlurReveal>
      ...
      <section className="flex flex-col gap-10 pt-20 pb-10 p-4 md:mx-[5%]">
        <div className="flex flex-col justify-center items-center mx-auto max-w-3xl gap-[19px] mb-10">
          ...
          <BlurReveal preset="slide-right" duration={3}><h2 className="md:text-[32px] text-[28px] text-center font-medium leading-[120%]">Latest advanced technologies to ensure everything you need</h2></BlurReveal>
          <BlurReveal preset="slide-right" duration={3}><p className='text-[#939395] md:w-[60%] w-[90%] mx-auto text-center'>maximize your team productivity with our advanced technologies built specifically for you.</p></BlurReveal>
        </div>
      ...
      <section className="flex flex-col gap-10 lg:px-[6%] md:px-[3%] p-4">
        ...
        <div className="relative flex md:flex-nowrap flex-wrap w-full gap-8 bg-gray-100 dark:bg-[#191919] rounded-lg md:pl-[6%] p-6 pb-0 md:h-[400px]">
          <div className="flex flex-col justify-between gap-8 md:w-[30%] py-[6%]">
            <BlurReveal preset="slide-right" duration={3}><h3 className="font-semibold text-lg">Clear Task Visibility</h3></BlurReveal>

            <BlurReveal preset="slide-right" duration={3}><p>Track projects, due dates, and priorities from a single dashboard so your team always knows what to do next.</p></BlurReveal>

            <Button href="/auth/signup" variant="primary" className="">
              <BlurReveal preset="slide-right" duration={3}>Learn more</BlurReveal>
            </Button>
          </div>
        ...
        <div className="flex md:flex-nowrap flex-wrap gap-[32px]">
          <div className="flex flex-col md:w-[50%] w-full gap-4 bg-gray-100 dark:bg-[#191919] rounded-lg md:p-[6%] p-6">
            <BlurReveal preset="slide-right" duration={3}><h3 className="font-medium text-[80px] font-semibold">AI</h3></BlurReveal>

            <BlurReveal preset="slide-right" duration={3}><p>Intelligent task management powered by AI scheduling, prioritization, task organization, and productivity assistance.</p></BlurReveal>
          </div>

          <div className="flex flex-col justify-between md:w-[50%] w-full gap-4 bg-gray-100 dark:bg-[#191919] rounded-lg md:p-[6%] p-6">
            <BlurReveal preset="slide-right" duration={3}><h3 className="font-semibold text-lg">Simple & Distraction-Free</h3></BlurReveal>

            <BlurReveal preset="slide-right" duration={3}><p>Designed with clarity in mind. No overwhelming dashboards or bloated workflows — just a clean productivity system focused on helping you get work done faster.</p></BlurReveal>
          </div>
        </div>
      ...
      <section className="flex flex-col items-center justify-center gap-10 lg:p-[6%] p-[10%] sm:mx-[6%] mt-20 mx-4 mb-12 rounded-[12px] bg-primary text-white">
        <div>
          <BlurReveal preset="slide-right" duration={3}><h2 className="md:text-[32px] text-[24px] font-medium leading-[110%] text-center">Start achieving more with Flashtasks today</h2></BlurReveal>
        </div>

        <div>
          <Button className="z-2 bg-white text-primary hover:bg-gray-100" variant="tertiary" href="/auth/login">
            <BlurReveal preset="slide-right" duration={3}>Get Started Free</BlurReveal>
          </Button>
        </div>
      </section>
