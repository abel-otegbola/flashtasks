...
function InvitationAcceptPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6 py-12">
      <section className="w-full max-w-2xl flex flex-col gap-6 bg-white dark:bg-dark-bg md:rounded-[10px] p-6 shadow-[0px_4px_12px_0px_#80808010] border border-gray-500/[0.1]">
        <div className="flex justify-between gap-6 items-start flex-wrap">
          <div className="flex flex-col gap-3">
            ...
            <p>Use this page to confirm a team invitation from your email link.</p>
          </div>
